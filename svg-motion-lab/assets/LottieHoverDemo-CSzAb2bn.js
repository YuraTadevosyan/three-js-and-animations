import{n as e}from"./rolldown-runtime-Bh1tDfsg.js";import{E as t,M as n,O as r,_ as i,b as a,k as o,l as s,u as c,x as l,y as u}from"./vue-vendor-DyLt9Y6i.js";import{t as d}from"./DemoCard-RFjb2ej6.js";import{t as f}from"./lottie-DFQohqmF.js";import{t as p}from"./orbit-BmAjmpgu.js";var m=e(f(),1),h=`<script setup lang="ts">
...
`,g={class:`pointer-events-none absolute inset-x-0 bottom-3 text-center font-mono text-xs text-muted-foreground`},_=i({__name:`LottieHoverDemo`,setup(e){let i=r(null),f=r(!1),_=null;a(()=>{i.value&&(_=m.default.loadAnimation({container:i.value,renderer:`svg`,loop:!0,autoplay:!1,animationData:p}))});function v(){f.value=!0,_?.setDirection(1),_?.play()}function y(){f.value=!1,_?.setDirection(-1),_?.play()}return u(()=>_?.destroy()),(e,r)=>(l(),c(d,{title:`Hover to play`,blurb:`Pointer-driven playback — hovering runs it forward, leaving reverses it via setDirection.`,tags:[`lottie-web`,`setDirection`,`interactive`],source:o(h),filename:`LottieHoverDemo.vue`},{stage:t(()=>[s(`div`,{ref_key:`container`,ref:i,class:`h-full w-full max-w-[70%]`,onMouseenter:v,onMouseleave:y},null,544),s(`div`,g,n(f.value?`▶ forward`:`hover the animation`),1)]),controls:t(()=>[...r[0]||(r[0]=[s(`span`,{class:`text-xs text-muted-foreground`},`Move your pointer over the animation.`,-1)])]),_:1},8,[`source`]))}});export{_ as default};