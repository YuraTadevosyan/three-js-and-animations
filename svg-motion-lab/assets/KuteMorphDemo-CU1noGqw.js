...
`,_=`M168 100 C 168 137.56 137.56 168 100 168 C 62.44 168 32 137.56 32 100 C 32 62.44 62.44 32 100 32 C 137.56 32 168 62.44 168 100 Z`,v=`M168 100 C 168 168 168 168 100 168 C 32 168 32 168 32 100 C 32 32 32 32 100 32 C 168 32 168 32 168 100 Z`,y=r({__name:`KuteMorphDemo`,setup(r){let y=n(null),b=n(!0),x=null;function S(){let e=y.value?.querySelector(`.morph`);e&&(x?.stop(),e.setAttribute(`d`,_),x=h.fromTo(e,{path:_},{path:v},{duration:1500,repeat:999,yoyo:!0,easing:`easingCubicInOut`}),b.value&&x.start())}function C(){x&&(b.value=!b.value,b.value?x.resume():x.pause())}return i(S),f(()=>x?.stop()),(n,r)=>(d(),u(p,{title:`Path morph`,blurb:`KUTE's cubic-morph plugin interpolates one path outline into another — here a clean circle ⇄ square.`,tags:[`KUTE.js`,`path`,`morph`],source:s(g),filename:`KuteMorphDemo.vue`},{stage:e(()=>[(d(),a(`svg`,{ref_key:`stage`,ref:y,viewBox:`0 0 200 200`,class:`h-full w-full max-w-[68%]`},[r[0]||(r[0]=c(`defs`,null,[c(`linearGradient`,{id:`kute-morph-grad`,x1:`0`,y1:`0`,x2:`1`,y2:`1`},[c(`stop`,{offset:`0`,"stop-color":`hsl(265 90% 66%)`}),c(`stop`,{offset:`1`,"stop-color":`hsl(200 90% 60%)`})])],-1)),c(`path`,{class:`morph`,d:_,fill:`url(#kute-morph-grad)`})],512))]),controls:e(()=>[o(m,{active:b.value,onClick:C},{default:e(()=>[l(t(b.value?`Pause`:`Play`),1)]),_:1},8,[`active`])]),_:1},8,[`source`]))}});export{y as default};