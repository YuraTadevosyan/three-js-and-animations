...
`,_=n({__name:`KuteTransformDemo`,setup(n){let _=t(null),v=t(!0),y=null;function b(){let e=_.value?.querySelector(`.emblem`);e&&(y?.stop(),y=h.fromTo(e,{svgTransform:{rotate:0,scale:1}},{svgTransform:{rotate:360,scale:1.35}},{duration:2400,repeat:999,yoyo:!0,transformOrigin:`50% 50%`,easing:`easingCubicInOut`}),v.value&&y.start())}function x(){y&&(v.value=!v.value,v.value?y.resume():y.pause())}return r(b),f(()=>y?.stop()),(t,n)=>(d(),u(p,{title:`SVG transform`,blurb:`Rotate and scale an SVG group about a bbox-relative origin — one svgTransform property, one transform attribute.`,tags:[`KUTE.js`,`svgTransform`,`origin`],source:s(g),filename:`KuteTransformDemo.vue`},{stage:e(()=>[(d(),i(`svg`,{ref_key:`stage`,ref:_,viewBox:`0 0 200 200`,class:`h-full w-full max-w-[62%]`},[...n[0]||(n[0]=[c(`g`,{class:`emblem`},[c(`rect`,{x:`62`,y:`62`,width:`76`,height:`76`,rx:`18`,fill:`none`,stroke:`hsl(265 90% 66%)`,"stroke-width":`6`}),c(`circle`,{cx:`100`,cy:`100`,r:`20`,fill:`hsl(200 90% 60%)`}),c(`circle`,{cx:`100`,cy:`52`,r:`7`,fill:`hsl(265 90% 72%)`}),c(`circle`,{cx:`148`,cy:`100`,r:`7`,fill:`hsl(320 85% 66%)`}),c(`circle`,{cx:`100`,cy:`148`,r:`7`,fill:`hsl(150 80% 55%)`}),c(`circle`,{cx:`52`,cy:`100`,r:`7`,fill:`hsl(40 95% 60%)`})],-1)])],512))]),controls:e(()=>[a(m,{active:v.value,onClick:x},{default:e(()=>[l(o(v.value?`Pause`:`Play`),1)]),_:1},8,[`active`])]),_:1},8,[`source`]))}});export{_ as default};