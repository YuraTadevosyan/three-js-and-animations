import{E as e,O as t,S as n,_ as r,f as i,h as a,j as o,k as s,l as c,m as l,s as u,u as d,x as f,y as p}from"./vue-vendor-BcWsErVS.js";import{a as m,n as h}from"./anime-DrPEU4hz.js";import{t as g}from"./DemoCard-DZ0aUJ0d.js";import{t as _}from"./CtrlButton-JMR97-BC.js";var v=`<script setup lang="ts">
...
`,y={viewBox:`0 0 200 200`,class:`h-full w-full`},b=[`d`],x=[`d`],S=r({__name:`MorphDemo`,setup(r){let S=[{key:`blob`,label:`Blob`},{key:`star`,label:`Star`},{key:`heart`,label:`Heart`}],C={blob:`M100 30 C 142 30 170 62 170 100 C 170 140 140 170 100 170 C 60 170 30 138 30 100 C 30 62 58 30 100 30 Z`,star:`M100 28 L118 76 L170 78 L128 110 L144 158 L100 130 L56 158 L72 110 L30 78 L82 76 Z`,heart:`M100 166 C 38 122 28 80 54 58 C 78 38 100 60 100 80 C 100 60 122 38 146 58 C 172 80 162 122 100 166 Z`},w=t(null),T=t({}),E=t(`blob`),D=null;function O(e){let t=T.value[e];!w.value||!t||e===E.value||(E.value=e,D?.pause(),D=m(w.value,{d:h(t),duration:900,ease:`inOut(3)`}))}return p(()=>D?.pause()),(t,r)=>(f(),d(g,{title:`Shape morphing`,blurb:`Interpolate one path's outline into another, even across different point counts.`,tags:[`anime.js`,`svg.morphTo`,`path d`],source:s(v),filename:`MorphDemo.vue`},{stage:e(()=>[(f(),i(`svg`,y,[r[0]||(r[0]=c(`defs`,null,[c(`linearGradient`,{id:`mo-grad`,x1:`0`,y1:`0`,x2:`1`,y2:`1`},[c(`stop`,{offset:`0`,"stop-color":`hsl(265 90% 66%)`}),c(`stop`,{offset:`1`,"stop-color":`hsl(175 84% 55%)`})])],-1)),(f(),i(u,null,n(S,e=>c(`path`,{key:e.key,ref_for:!0,ref:t=>T.value[e.key]=t,d:C[e.key],class:`hidden`},null,8,b)),64)),c(`path`,{ref_key:`source`,ref:w,d:C.blob,fill:`url(#mo-grad)`},null,8,x)]))]),controls:e(()=>[(f(),i(u,null,n(S,t=>a(_,{key:t.key,active:E.value===t.key,onClick:e=>O(t.key)},{default:e(()=>[l(o(t.label),1)]),_:2},1032,[`active`,`onClick`])),64))]),_:1},8,[`source`]))}});export{S as default};